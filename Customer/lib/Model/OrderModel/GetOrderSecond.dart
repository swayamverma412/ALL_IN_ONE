...
class GetOrderSecond {
  ...
  GetOrderSecond.fromJson(dynamic json) {
    _status = json['status'];
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
  ...
  bool? _status;
  List<Data>? _data;
GetOrderSecond copyWith({  bool? status,
  List<Data>? data,
}) => GetOrderSecond(  status: status ?? _status,
  data: data ?? _data,
);
...
/// deliveryLocation : {"type":"Point","coordinates":[77.594566,12.971599],"address":"ravena house 3rd floor","addressType":"home"}
...
/// rating : 1
/// isDeleted : false
/// createdAt : "2022-12-24T14:32:09.757Z"
/// updatedAt : "2022-12-24T14:32:09.757Z"
/// __v : 0
...
/// address : "ravena house 3rd floor"
/// addressType : "home"
