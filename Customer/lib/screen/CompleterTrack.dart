...
class TrackLocation2 extends StatefulWidget {
  Data? data;


  TrackLocation2(this.data);

  @override
  State<TrackLocation2> createState() => _TrackLocationState();
}

class _TrackLocationState extends State<TrackLocation2> {
  ...
  void initState() {
    ...
    double lat=widget.data!.vendor!.googleMapsLocation!.coordinates![0].toDouble();
    double lng=widget.data!.vendor!.googleMapsLocation!.coordinates![1].toDouble();
    setState((){
      _markers.add(
          Marker(
            markerId: MarkerId("1"),
            position: LatLng(widget.data!.vendor!.googleMapsLocation!.coordinates![0].toDouble(), widget.data!.vendor!.googleMapsLocation!.coordinates![1].toDouble()),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child:load?Center(child: CircularProgressIndicator(),):GoogleMap(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                        children:List.generate(widget.data!.products!.length, (index){
                                          return groceryList(
                                            type: widget.data!.products![index].title.toString(),
                                            weight: widget.data!.products![index].price.toString(),
                                            quantity: widget.data!.items![index].quantity.toString(),
                                            totalPrice: (widget.data!.products![index].price!*widget.data!.items![index].quantity!).toString(),
                                          );
                                        }),
                                        /* children: [
                                          groceryList(
                                          ...
                                          children: [
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets
                                                        .fromLTRB(0, 10, 40, 0),
                                                    child: payment(
                                                      amount: int.parse(widget.data!.serviceFee.toString()),
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets
                                                        .fromLTRB(0, 10, 40, 0),
                                                    child: payment(
                                                      amount: int.parse(widget.data!.deliveryFee.toString()),
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets
                                                        .fromLTRB(0, 10, 40, 0),
                                                    child: payment(
                                                      amount: int.parse(widget.data!.discount.toString()),
                                            ...
                                            Row(
                                              ...
                                              MainAxisAlignment
                                                  .spaceBetween,
                                              children: [
                                                Text(widget.data!.products!.length.toString() +" item"),
                                                Padding(
                                                  padding: EdgeInsets.only(
                                                      top: 30.0, bottom: 30),
                                                  child: SizedBox(
