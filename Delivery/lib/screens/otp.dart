  ...
  void verify_otp(String otp) {
    ...
    authRepo().verifyOtp(par).then((value)async{
      ...
      if(value.statusCode==200){
        ...
        await SharedPreferenceClass.SetSharedData(AppContent.CUSTOMERID, data["riderId"]);
        ...
        if(data["message"] == "Not Registered, Signup Now!"){
          ...
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => Auth(number: widget.number,reffered: widget.refer,)));
