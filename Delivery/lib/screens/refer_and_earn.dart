...
class _ReferAndEarnState extends State<ReferAndEarn> {
  ...
  Widget referAndEarn(String type) {
    return SizedBox(
          ...
          SizedBox(
            ...
            child: InkWell(
              onTap: () {
                pushNewScreen(
                  context,
                  screen: MyTeam(type:type,code: data[0]["referralCode"].toString()),
                  withNavBar: false,
                );
              },
              child: Card(
        ...
        body: SingleChildScrollView(
          child: Column(
              ...
              children: [
                ...
                load?Center(child: CircularProgressIndicator(),):error?NoDataScreen(text: "Error in Refer"): DefaultTabController(
                  length: 3,
                  child: SizedBox(
                    width: w(1),
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: ContainedTabBarView(
                            ...
                            views: [
                              referAndEarn("customers"),
                              referAndEarn("venders"),
                              referAndEarn("riders"),
                            ],
                          ),
                        ),
