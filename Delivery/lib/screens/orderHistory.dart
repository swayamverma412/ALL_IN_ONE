...
//past orders
  ...
  getshared() async {
    ...
    Provider.of<ordercontroller>(context, listen: false).getOrder_Status(id!);
  }
                         ...
                         // physics: NeverScrollableScrollPhysics(),
                          ...
                          itemBuilder: ((context, index) {
                            ...
                            return currentOrders(
                              ...
                              image: model
                                  .ordere_list!
                                  .data![index].vendorDetails![0].shopPicture!,
                              date: "15",
                              status: model
                                  .ordere_list!
                                  .data![index].status![model.ordere_list!.data![index].status!.length - 1]
                                  .toString(),
                              storeName: model
                                  .ordere_list!
                                  .data![index].vendorDetails![0].businessName
                                  .toString(),
                              time: "12:00",
                              to: model
                                  .ordere_list!
                              ...
                              type: model
                                  .ordere_list!
                                  .data![index].customerDetails![0].name
                                  .toString(),
                            );
                          }),
                        ),
