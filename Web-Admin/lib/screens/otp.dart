  ...
  void verify_otp(String otp) {
    ...
    authRepo().verifyOtp(par).then((value)async{
      ...
      if(value.statusCode==200){
        ...
        await SharedPreferenceClass.SetSharedData(AppContent.CUSTOMERID, data["vendorId"]);
        final pra={
          "":"",
        };
        authRepo().generateQr(pra);
        Navigator.pushAndRemoveUntil(
          context, MaterialPageRoute(builder: (context) => PersistentNavBar()),(route) => false,);
        ...
        if(data["message"] == "Not Registered, Signup Now!"){
          ...
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => Location(widget.number,widget.refer)));
